...
window.ttsRegisterDictionary("es", {
  ...
  "pv.s1p1": "Cuando envías el formulario de contacto guardamos el nombre de la empresa, tu correo de trabajo, el momento que elegiste, tu mensaje, el idioma en que estaba el sitio y una versión truncada de tu dirección IP. Nada más.",
  ...
  "pv.s7h": "Contacto",
  "pv.s7p1": "logistika, Santiago de Querétaro, Querétaro, México. Para cualquier solicitud sobre tus datos, usa el formulario de contacto o la dirección publicada en el sitio."
});
